...
public class AgendaView extends RecyclerView
{
    ...
    {
        if (dy != 0)
        { // avoid loading more or triggering notification on 1st layout
            loadMore();
            notifyDateChange();
        }
    }
    ...
    void loadMore()
    {
        ...
        else if (getLinearLayoutManager().findLastVisibleItemPosition() == mAdapter.getItemCount() - 1)
        {
    ...
    static class AgendaLinearLayoutManager extends LinearLayoutManager
    {
                ...
                int position)
        {
                    ...
                    recyclerView.getContext())
            {
                ...
                {
                    return AgendaLinearLayoutManager.this.computeScrollVectorForPosition(
                            targetPosition);
                }
