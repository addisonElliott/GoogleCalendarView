...
import com.aelliott.googlecalendarview.ViewUtils;
...
public class EventEditView extends RelativeLayout
{
    ...
    public EventEditView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        int horizontalPadding = context.getResources().getDimensionPixelSize(
                R.dimen.horizontal_padding), verticalPadding = context
                .getResources()
    ...
    private void setupViews()
    {
        ...
        mEditTextTitle.addTextChangedListener(new TextWatcher()
        {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count)
            {
                ...
                mTextInputTitle.setError(TextUtils.isEmpty(s) ? getResources().getString(
                        R.string.warning_empty_title) : null);
            }
    ...
    {
        new AlertDialog.Builder(getContext()).setCursor(mCursor,
                ...
                }, CalendarContract.Calendars.CALENDAR_DISPLAY_NAME).setNegativeButton(
