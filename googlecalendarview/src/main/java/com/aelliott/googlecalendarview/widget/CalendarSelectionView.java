...
public class CalendarSelectionView extends ListView
{
    ...
    public void swapCursor(@Nullable CalendarCursor cursor, @Nullable Set<String> exclusions)
    {
        ...
        if (cursor != null)
        {
            ...
            {
                if (exclusions != null && !exclusions.contains(
                        String.valueOf(mCursorAdapter.getItemId(i))))
                {
    ...
    class CalendarCursorAdapter extends SimpleCursorAdapter
    {
        ...
        {
            super(context, R.layout.list_item_calendar, null,
                    new String[] {CalendarContract.Calendars.CALENDAR_DISPLAY_NAME},
                    new int[] {R.id.text_view_title}, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
        }
        ...
        public void bindView(View view, Context context, Cursor cursor)
        {
            ...
            view.setBackgroundColor(
                    mColors[Math.abs((int)(((CalendarCursor)cursor).getId() % mColors.length))]);
        }
